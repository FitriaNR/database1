...
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, await, sleep } = require('./data/lib/myfunc')
//=================================================//
var low
try {
low = require('lowdb')
} catch (e) {
low = require('./data/lib/lowdb')}
//=================================================//
const { Low, JSONFile } = low
const mongoDB = require('./data/lib/mongoDB')
//=================================================//
...
new mongoDB(opts['db']) :
new JSONFile(`data/db/database.json`)
)
...
require("./start")(haikal, m, chatUpdate, store)
} catch (err) {
console.log(err)}})
//=================================================//
...
let link = `https://www.youtube.com/channel/UCOVW4A7rywiqR9Ud24WqrNw`
let buttons = [
{buttonId: `FYVVIP.☆`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
document: fs.readFileSync('./data/lib/tes.xlsx'),
mimetype: feler,
...
let { writeExif } = require('./data/lib/exif')
...
ext: '.bin'}
filename = path.join(__filename, '../data/db/' + new Date * 1 + '.' + type.ext)
